...
export const WHATSAPP_NUMBER = "6282127147632";
export const WHATSAPP_MESSAGE = "Halo, saya tertarik dengan promo mobil Suzuki dan ingin bertanya lebih lanjut.";
export const PHONE_NUMBER = "6282127147632";
export const EMAIL_ADDRESS = "vinajuita7@gmail.com";
export const INSTAGRAM_USERNAME = "@vina_suzukinjsbdg";
export const INSTAGRAM_URL = "https://www.instagram.com/vina_suzukinjsbdg";
...
export const CAR_DATA: CarModel[] = [
  {
    ...
    variants: [
      ...
      { name: 'ALPHA MT HYBRID', price: 303300000 },
      { name: 'ALPHA MT HYBRID 2TONE', price: 305300000 },
      { name: 'ALPHA AT HYBRID', price: 314200000 },
      { name: 'ALPHA AT HYBRID 2TONE', price: 316300000 },
      { name: 'ALPHA KURO EDITION AT HYBRID', price: 318200000 },
      { name: 'ALPHA KURO EDITION AT HYBRID 2TONE', price: 320300000 },
    ],
  },
  {
...
export const TESTIMONIALS: Testimonial[] = [
    {
        ...
        photoUrl: 'https://i.imghippo.com/files/kNA9923XmA.jpg',
        quote: 'g'
    },
    {
        customerName: 'Yusafri Edison',
        carModel: 'Suzuki Fronx',
        photoUrl: 'https://i.imghippo.com/files/CSs4540yK.jpg',
        quote: 'g'
    },
    {
        customerName: 'Teten Hidayat',
        carModel: 'Suzuki Baleno',
        photoUrl: 'https://i.imghippo.com/files/xEE9045leY.jpg',
        quote: 'g'
    },
    {
        customerName: 'Iwan',
        carModel: 'Suzuki Jimnny',
        photoUrl: 'https://i.imghippo.com/files/gWcj7494Dgs.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ismansyah',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/IY5044xc.jpg',
        quote: 'g'
    },
    {
        customerName: 'Husni',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/zBM5710Ews.jpg',
        quote: 'g'
    },
    {
        customerName: 'Hendrik',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/gNu8132bYM.jpg',
        quote: 'g'
    },
    {
        customerName: 'Casmudi',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/ZKi6513r.jpg',
        quote: 'g'
    },
    {
        customerName: 'Asep Zaenal',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/jpmd4315zlk.jpg',
        quote: 'g'
    },
    {
        customerName: 'Realita Malik',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/SqFK1655Iwg.jpg',
        quote: 'g'
    },
    {
        customerName: 'Handa',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/wvd1383xjU.jpg',
        quote: 'g'
    },
    {
        customerName: 'Dede',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/NnTN9125aKw.jpg',
        quote: 'g'
    },
    {
        customerName: 'Hj Cece',
        carModel: 'Suzuki New Carry',
        photoUrl: 'https://i.imghippo.com/files/hEj9298xOE.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ari Setiawan',
        carModel: 'Suzuki Grand Vitara',
        photoUrl: 'https://i.imghippo.com/files/LXY9736yA.jpg',
        quote: 'g'
    },
    {
        customerName: 'Desa Bojong',
        carModel: 'Suzuki APV Ambulance',
        photoUrl: 'https://i.imghippo.com/files/rB7625Dyc.jpg',
        quote: 'g'
    },
    {
        customerName: 'Asri',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/OZ1993QQw.jpg',
        quote: 'g'
    },
];
