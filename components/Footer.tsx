          ...
          <div>
            ...
            <ul className="space-y-4 md:space-y-0 md:flex md:space-x-8 md:items-center">
              <li className="flex items-center justify-center">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">+62 821-2714-7632</a>
              </li>
              <li className="flex items-center justify-center">
                ...
                <a href={phoneUrl} className="hover:text-blue-400 transition-colors">+62 821-2714-7632</a>
              </li>
              <li className="flex items-center justify-center">
